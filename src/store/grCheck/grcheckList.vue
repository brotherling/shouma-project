  ...
  <section class="gcheckList_Assetcontent">
    ...
    <yd-button @click.native="grcheckList_click()" size="large" type="primary" bgcolor="#029EE6">核查</yd-button>
      ...
      <div class="grcheckList_foot">
        <div @click="clickNocheck"><i class="grcheckList_imgnocheck"></i><br>未核查</div>
        <span></span>
        <div @click="grcheckList_Imgsao"><i class="grcheckList_imgsao"></i><br>扫一扫</div>
        <span></span>
        <div  @click="clickcheck"><i class="grcheckList_imgcheck"></i><br>已核查</div>
    </div>
</div>
</template>
<script>
